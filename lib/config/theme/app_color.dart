...
class AppColor {
  ...
  final Color purple = const Color(0xFFDAE1FF);
  final Color green3 = const Color(0xFFE1E8EA);
  final Color green4 = const Color(0xFFB9D1D7);
  final Color dark = const Color(0xFF000000);
  final Color black = const Color(0xFF0E0E0E);
  final Color white = const Color(0xFFFFFFFF);
  final Color gray = const Color(0xFF676767);
  final Color gray10 = const Color(0xFF8A8A8A);
  final Color gray4 = const Color(0xFF141414);
  final Color gray3 = const Color(0xFF989898);
  final Color gray2 = const Color(0xFFCDCDCD);
  ...
  final Color blurColor2 = const Color(0xFFD1DEE1);
}
